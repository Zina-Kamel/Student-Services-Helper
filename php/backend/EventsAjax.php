...
<p class="eventname" style="margin-top:5px;"><strong>Name:</strong> <?php echo $cursor2array['Event_Name']; ?></p>
...
<p><strong>Club Name:</strong> <?php echo $cursor2array['Club_Name']; ?></p>